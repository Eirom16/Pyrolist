...
¡Pyrolist v2.1.0 ya está aquí! Esta versión introduce grandes cambios incluyendo la vista de Artistas en la biblioteca, notificaciones del sistema, mejoras significativas en la interfaz gráfica, y correcciones importantes de sincronización de audio.
